    ...
    return [
        ...
        DialogueScenario(
            ...
            turns=[
                ...
                TurnSpec("算了，不想说了", expect_empathy=True, expect_comfort_avatar=True),
            ],
        ...
        DialogueScenario(
            ...
            turns=[
                TurnSpec("我又乱花钱了，买了根本用不上的东西", expect_empathy=True, expect_comfort_avatar=True),
                TurnSpec("觉得自己好没用，管不住手", expect_empathy=True, expect_comfort_avatar=True),
            ],
        ...
        DialogueScenario(
            ...
            turns=[
                TurnSpec("跟对象吵架了，现在谁也不理谁", expect_empathy=True, expect_comfort_avatar=True),
                TurnSpec("其实也有我的问题，但就是拉不下脸", expect_empathy=True, expect_comfort_avatar=True),
