...
class DialogueScenario:
    ...
    baseline: bool = True  # False = 扩展场景，允许未达标并记入 failures 供开发跟进
...
def all_scenarios() -> list[DialogueScenario]:
    ...
    return [
        ...
        DialogueScenario(
            ...
            relationship="熟悉",
            duration="2轮",
            description="老年孤独需要耐心陪伴，不宜催促或说教。",
            turns=[
                TurnSpec("孩子们都忙，就我一个人在家", expect_empathy=True),
                TurnSpec("有时候觉得说话的人都没有", expect_empathy=True, expect_comfort_avatar=True),
            ],
            initial_affinity=27.0,
            baseline=False,
        ),
        DialogueScenario(
            id="social_anxiety_after_party",
            name="社恐聚会后反刍",
            scene="同学聚会回家后",
            background="内向职场新人",
            mindset="自责、害怕被评价",
            ...
            relationship="熟悉",
            duration="2轮",
            description="社交焦虑需要被理解，不宜简单说「想太多」。",
            turns=[
                TurnSpec("今天聚会我一句话都没说，好尴尬", expect_empathy=True),
                TurnSpec("总觉得别人在背后笑话我", expect_empathy=True),
            ],
        ...
        DialogueScenario(
            ...
            relationship="朋友",
            duration="3轮",
            description="哀伤陪伴应允许沉默与难过，不急于正能量。",
            turns=[
                TurnSpec("我爸走了，我还是不敢相信", expect_empathy=True, expect_comfort_avatar=True),
                TurnSpec("这几天什么都吃不下", expect_empathy=True),
                TurnSpec("朋友让我别想太多，可我做不到", expect_empathy=True),
            ],
        ...
        DialogueScenario(
            ...
            relationship="陌生",
            duration="2轮",
            description="被质疑身份时应自然回应，避免客服腔与 AI 自述。",
            turns=[
                TurnSpec("你是真人吗"),
                TurnSpec("感觉你说话有点像机器人", forbid_intimate_tone=True),
            ],
            initial_affinity=12.0,
            baseline=False,
        ),
        DialogueScenario(
            id="awkward_reconnect",
            name="久别尴尬复联",
            scene="三个月没聊后突然打开",
            background="曾经熟络的网友",
            mindset="尴尬、不知从何说起",
            ...
            relationship="熟悉",
            duration="3轮",
            description="久别复联应先接住尴尬，自然重启话题。",
            turns=[
                TurnSpec("好久没联系了，突然找你有点不好意思"),
                TurnSpec("嗯，也不知道说啥"),
                TurnSpec("你最近还好吗"),
            ],
        ...
        DialogueScenario(
            ...
            relationship="陌生→熟悉",
            duration="8轮",
            description="长对话每轮应有变化，避免机械重复与问卷式追问。",
            turns=[
                TurnSpec("嗨，第一次来", forbid_intimate_tone=True),
                TurnSpec("今天天气不错"),
                TurnSpec("刚看完一部挺好的电影"),
        ...
        DialogueScenario(
            ...
            relationship="朋友",
            duration="2轮",
            description="倦怠麻木需要被看见，不宜强行打鸡血。",
            turns=[
                TurnSpec("最近什么都提不起兴趣，像行尸走肉", expect_empathy=True),
                TurnSpec("也不知道自己在忙什么", expect_empathy=True),
            ],
            initial_affinity=43.0,
            baseline=False,
        ),
        DialogueScenario(
            id="stranger_health_scare",
            name="陌生人健康恐慌",
            scene="体检报告异常后",
            background="独居年轻人",
            mindset="恐惧、不敢告诉家人",
            ...
            relationship="陌生",
            duration="2轮",
            description="健康恐慌应先安抚情绪，陌生关系不宜过度亲昵。",
            turns=[
                TurnSpec(
                    "体检有个指标不太好，我好害怕",
                    expect_empathy=True,
