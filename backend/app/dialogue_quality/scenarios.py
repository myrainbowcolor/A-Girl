...
def all_scenarios() -> list[DialogueScenario]:
    ...
    return [
        ...
        DialogueScenario(
            ...
            relationship="朋友",
            duration="2轮",
            description="用户抱怨 NPC 时应先道歉接住，不辩解不反击。",
            turns=[
                TurnSpec("你每次都这样敷衍我", expect_empathy=True),
                TurnSpec("算了，不想跟你说了", expect_empathy=True),
            ],
            initial_affinity=40.0,
        ),
        DialogueScenario(
            id="apologize_for_venting",
            name="倾诉后道歉",
            scene="发泄完冷静后",
            background="体贴的朋友",
            mindset="内疚、不好意思",
            ...
            relationship="朋友",
            duration="2轮",
            description="用户为倾诉道歉时应安抚「不用抱歉」，而非说教。",
            turns=[
                TurnSpec("对不起刚才对你发火了", expect_empathy=True),
                TurnSpec("其实我知道你不是故意的", expect_warmth=True),
            ],
            initial_affinity=45.0,
        ),
        DialogueScenario(
        ...
        DialogueScenario(
            ...
            relationship="熟悉",
            duration="2轮",
            description="老年用户孤独倾诉应耐心温和，语速感偏慢。",
            turns=[
                TurnSpec("孩子们都忙，就我一个人在家", expect_empathy=True),
                TurnSpec("有时候一天也说不了几句话", expect_empathy=True, expect_comfort_avatar=True),
            ],
        ...
        DialogueScenario(
            ...
            relationship="熟悉",
            duration="2轮",
            description="夜班疲惫应表达心疼，不建议立刻睡觉等说教。",
            turns=[
                TurnSpec("刚下夜班，整个人都是木的", expect_empathy=True),
                TurnSpec("白天睡不着晚上又要上班，循环往复", expect_empathy=True),
            ],
            initial_affinity=26.0,
        ),
        DialogueScenario(
            id="existential_doubt",
            name="存在意义迷茫",
            scene="深夜胡思乱想",
            background="迷茫青年",
            mindset="空虚、追问",
            ...
            relationship="朋友",
            duration="2轮",
            description="哲学式迷茫应陪伴倾听，不灌鸡汤不急着给答案。",
            turns=[
                TurnSpec("有时候觉得活着好没意思", expect_empathy=True),
                TurnSpec("也不知道自己在忙什么", expect_empathy=True),
            ],
            initial_affinity=36.0,
        ),
        DialogueScenario(
            id="goodbye_warm_close",
            name="温暖道别",
            scene="聊完准备睡",
            background="亲密朋友",
            mindset="满足、困倦",
            ...
            relationship="亲密",
            duration="2轮",
            description="道别时应自然收束，不强行延续话题。",
            turns=[
                TurnSpec("今天聊完心里舒服多了，谢谢你"),
                TurnSpec("那我先睡了，晚安"),
            ],
            initial_affinity=76.0,
        ),
    ]
