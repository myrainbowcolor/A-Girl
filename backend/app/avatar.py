...
_LIVE2D_PRESETS = {
    "微笑": {"mouth_form": 1.0, "brow": 0.25, "eye_open": 0.92, "cheek": 0.45},
    "大笑": {"mouth_form": 1.0, "brow": 0.45, "eye_open": 0.65, "cheek": 0.7},
    "难过": {"mouth_form": -0.85, "brow": -0.65, "eye_open": 0.55, "cheek": 0.0},
    "担心": {"mouth_form": -0.45, "brow": -0.85, "eye_open": 1.05, "cheek": 0.05},
    "惊讶": {"mouth_form": 0.1, "brow": 0.85, "eye_open": 1.12, "cheek": 0.15},
    "平静": {"mouth_form": 0.18, "brow": 0.05, "eye_open": 1.0, "cheek": 0.08},
}
...
def emotion_to_avatar(emotion: EmotionState, is_crisis: bool = False) -> AvatarCue:
    ...
    # 非线性强度：情绪越鲜明越夸张，弱情绪保持柔和
    raw = (abs(p) + abs(a)) / 2
    intensity = min(1.0, 0.25 + raw * 0.85 + (0.1 if raw > 0.5 else 0.0))
