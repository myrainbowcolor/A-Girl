...
**Cursor Automations** 自动迭代请用 [docs/AUTOMATIONS-SDD.md](docs/AUTOMATIONS-SDD.md) 中的 Prompt 模板；定时「NPC训练」见 [docs/AUTOMATIONS-NPC-TRAINING.md](docs/AUTOMATIONS-NPC-TRAINING.md)；「情感 NPC 测试」见 [docs/AUTOMATIONS-DIALOGUE-QUALITY.md](docs/AUTOMATIONS-DIALOGUE-QUALITY.md)。
