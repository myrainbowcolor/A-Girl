...
#### Scenario: 用户疲惫想倾诉时 prompt 含疲惫想聊侧重

- **WHEN** 构建 system prompt 且 `user_text` 同时含疲惫词（累/好累/心累/辛苦）与倾诉意愿词（靠着说/跟你说/想聊聊）
- **THEN** prompt 包含「本轮侧重」段，指引先接住疲惫、邀请慢慢说，禁止「不想说也没关系」类封闭话术
