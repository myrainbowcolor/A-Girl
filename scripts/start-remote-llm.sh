...
AGIRL_LLM_REPLY_TEMPERATURE=0.72
...
AGIRL_PROACTIVE_SCHEDULER_ENABLED=true
AGIRL_PROACTIVE_SCHEDULER_INTERVAL_SECONDS=90
AGIRL_PROACTIVE_WARM_IDLE_SECONDS=480
AGIRL_PROACTIVE_IDLE_SECONDS=2700
AGIRL_PROACTIVE_GLOBAL_COOLDOWN_SECONDS=720
AGIRL_PROACTIVE_INSIGHT_MIN_IDLE_SECONDS=300
AGIRL_PROACTIVE_INSIGHT_COOLDOWN_SECONDS=900
EOF
